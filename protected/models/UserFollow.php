...
class UserFollow extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('follow_tp', 'required'),
			array('uid, fuid', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('uid, fuid, follow_tp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'fu' => array(self::BELONGS_TO, 'User', 'fuid'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('follow_tp',$this->follow_tp,true);
