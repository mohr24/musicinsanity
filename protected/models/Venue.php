...
class Venue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('vname, location, city', 'required'),
			array('vname, location', 'length', 'max'=>20),
			array('city', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('vid, vname, location, city', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'concerts' => array(self::HAS_MANY, 'Concert', 'vid'),
			'recommendations' => array(self::HAS_MANY, 'Recommendation', 'vid'),
		);
	}
